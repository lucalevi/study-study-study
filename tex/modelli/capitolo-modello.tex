% ------------------------------------------------------------------
%  Capitolo modello: mostra tutti gli elementi della classe.
%  NON fa parte del libro: si compila con modelli/modello.tex.
% ------------------------------------------------------------------
\chapter{Non per la scuola, ma per la vita}
\label{cap:modello}

\epigrafe[Impariamo non per la vita, ma per la scuola.]{Non vitae sed
  scholae discimus.}{Seneca, Epistulae ad Lucilium 106, 12}
...
Un'epigrafe o una citazione in greco si scrive direttamente in
Unicode: \emph{πάθει μάθος}. Un testo provvisorio si marca così:
\segnaposto{testo da scrivere}.
