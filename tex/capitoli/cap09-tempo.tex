...
%
%  STATO: prima stesura (23/09/2026), circa 3.850 parole.
...
È probabilmente il risultato più replicato di tutta la psicologia
...
\emph{difficoltà desiderabili}: condizioni che rendono lo studio più
...
risponde a chi gli chiede quale sia la più grande arte della memoria:
...
la sera non si riusciva a ripetere, il giorno dopo \enquote{si
...
dimenticare è lo stesso che fa ricordare. Non esiste forse una
formulazione più precisa, in tutta la letteratura antica, di ciò che la
psicologia avrebbe dimostrato duemila anni dopo.
...
un anno, la frazione scende a circa un ventesimo, cioè a due o tre
...
\begin{table}[tbp]
  ...
  \begin{tabular}{@{}>{\raggedright\arraybackslash}p{0.34\textwidth}>{\raggedright\arraybackslash}p{0.56\textwidth}@{}}
    ...
    \addlinespace
    un anno (un concorso, un esame di Stato) & 3--4 settimane \\
    \addlinespace
...
le riprese di uno stesso blocco possono arrivare a tre o quattro
