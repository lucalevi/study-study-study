...
%  formulazione qualitativa). Resta un \segnaposto per un ricordo
...
\segnaposto{qui l'autore può inserire un breve ricordo personale e vero,
in prima persona: per esempio un esame della propria laurea preparato
con cura, superato bene e dimenticato in pochi mesi; tre o quattro righe
al massimo}

Non è un'impressione tua. È uno dei fenomeni meglio documentati della
...
Ti propone invece un metodo. Non un metodo inventato dall'autore: un
